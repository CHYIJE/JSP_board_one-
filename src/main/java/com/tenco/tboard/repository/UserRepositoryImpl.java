...
public class UserRepositoryImpl implements UserRepository {
	...
	private static final String SELECT_USER_BY_USERNAME_AND_BY_PASSWORD = " SELECT * FROM users WHERE username = ? AND password = ? ";
	...
	public User getUserByusernameAndPassword(String username, String password) {
		User user = null;
		try (Connection conn = DBUtil.getConnection();
			PreparedStatement pstmt = conn.prepareStatement(SELECT_USER_BY_USERNAME_AND_BY_PASSWORD)){
			pstmt.setString(1, username);
